"""
readmission_pg.py
30-Day Hospital Readmission Prediction â€” Postgres path
...
INNER JOIN labels       l   ON ia.visit_occurrence_id = l.visit_occurrence_id
...
def train_and_evaluate(df, run_id, source):
    ...
    # Train/test split â€” time-based (use chronological order)
...
def main():
    ...
    print("=" * 58)
    print("  30-Day Readmission â€” Postgres Path")
    ...
    print(f"  âœ“ {len(df):,} rows extracted in {feat_time:.2f}s")
